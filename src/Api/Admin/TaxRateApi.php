...
final class TaxRateApi implements TaxRateApiInterface
{
    ...
    public function listPerPage(
        ...
        $data = $this->resourceClient->getResources('api/v2/admin/tax-rates', [], $limit, $queryParameters, $filterBuilder, $sortBuilder);
    ...
    {
        return $this->resourceClient->createResource('api/v2/admin/tax-rates', [], $data);
    }
