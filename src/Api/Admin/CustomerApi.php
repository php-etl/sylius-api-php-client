...
final class CustomerApi implements CustomerApiInterface
{
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->getResource('api/v2/admin/customers/%d', [$code]);
    }
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->deleteResource('api/v2/admin/customers/%d/user', [$code]);
    }
    ...
    {
        $data = $this->resourceClient->getResources('api/v2/admin/customers');
    ...
    {
        Assert::integer($code);
        return $this->resourceClient->upsertResource('api/v2/admin/customers/%d', [$code], $data);
    }
}
