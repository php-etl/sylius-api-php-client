...
class ProductAttributeApi implements ProductAttributeApiInterface
{
    ...
    {
        return $this->resourceClient->createResource('api/v2/admin/product-attributes', [], $data);
    }
    ...
    {
        $data = $this->resourceClient->getResources('api/v2/admin/product-attributes');
