...
class CatalogPromotionTranslationApiTest extends \PHPUnit\Framework\TestCase
{
    public function testGetCatalogPromotionTranslation()
    {
        ...
        $address = new Api\Admin\CatalogPromotionTranslationApi(
            new ResourceClient(
